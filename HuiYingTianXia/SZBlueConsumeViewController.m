...
@interface SZBlueConsumeViewController ()<AC_POSMangerDelegate,MF_POSMangerDelegate,MPosDelegate>
...
@implementation SZBlueConsumeViewController
...
- (void)waitingForCardSwipe:(BOOL)status
{
    if(status == SUCCESS) {
        ...
        SZBlueSwingCardViewController *swingCardVC = [[SZBlueSwingCardViewController alloc] init];
        swingCardVC.tadeType = self.tadeType;
