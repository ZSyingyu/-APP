...
#import "EmvSwipeControllerListener.h"
...
@interface SwipeHandler:NSObject<SwipeDelegate> {
    ...
    id<EmvSwipeControllerListener> mEmvSwipeListener;
}

@property(nonatomic, retain) id<SwipeListener> mSwipeListener;
@property(nonatomic, retain) id<EmvSwipeControllerListener> mEmvSwipeListener;
