...
@interface MFBTConsumeViewController ()<AC_POSMangerDelegate,MF_POSMangerDelegate,MPosDelegate>
...
@implementation MFBTConsumeViewController
...
- (void)waitingForCardSwipe:(BOOL)status
{
    if(status == SUCCESS) {
        ...
        MFBTSwingCardViewController *swingCardVC = [[MFBTSwingCardViewController alloc] init];
        swingCardVC.tadeType = self.tadeType;
