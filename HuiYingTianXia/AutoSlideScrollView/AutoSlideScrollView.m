...
- (MyPageControl *)pageControl
{
    ...
    if (self.totalPageCount > 1) {
        if (!_pageControl) {
            ...
            CGRect pageControlFrame = CGRectMake(CGRectGetMidX(self.scrollView.frame) - 0.5 * pageControlWidth , 0.85 * CGRectGetHeight(self.scrollView.frame), pageControlWidth, normalDotImage.size.height);
