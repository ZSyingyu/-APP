...
@interface EnterPwdViewController()<UITableViewDelegate, UITableViewDataSource,UITextFieldDelegate>
...
@implementation EnterPwdViewController
...
{
    __unsafe_unretained EnterPwdViewController *weakSelf = self;
...
//                                [MBProgressHUD showSuccess:error toView:vc.view];
//                            }
//                        }
                        NSString *error = [[ResponseDictionaryTool responseDic] objectForKey:item.n39];
                        HomePageViewController *homeVc = [[HomePageViewController alloc] init];
