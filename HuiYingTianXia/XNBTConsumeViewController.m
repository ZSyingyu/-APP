...
@interface XNBTConsumeViewController ()<AC_POSMangerDelegate,MF_POSMangerDelegate,MPosDelegate>
...
@implementation XNBTConsumeViewController
...
- (void)waitingForCardSwipe:(BOOL)status
{
    if(status == SUCCESS) {
        ...
        XNBTSwingCardViewController *swingCardVC = [[XNBTSwingCardViewController alloc] init];
        swingCardVC.tadeType = self.tadeType;
