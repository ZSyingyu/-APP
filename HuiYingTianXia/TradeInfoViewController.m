...
- (void)viewDidLoad {
    ...
    if (![self.cStatus isEqualToString:@""]) {
        ...
        if (![self.authorizeNum isEqualToString:@""]) {
            self.authorizeNumberLabel = [[UILabel alloc] initWithFrame:CGRectMake(10, CGRectGetMaxY(self.cashStatusLine.frame) + 3, 80, 30)];
            ...
            self.confirmBtn.frame = CGRectMake(20, CGRectGetMaxY(self.signView.frame) + 30, SCREEN_WIDTH - 40, 40);
            ...
            self.signView = [[UIView alloc] initWithFrame:CGRectMake(10, CGRectGetMaxY(self.cashStatusLine.frame) + 5, SCREEN_WIDTH - 20, 100)];
            self.signView.backgroundColor = [UIColor whiteColor];
            [self.baseScrollView addSubview:self.signView];
