...
@interface ZCBTADConsumeViewController ()<AC_POSMangerDelegate,MF_POSMangerDelegate,MPosDelegate>
...
@implementation ZCBTADConsumeViewController
...
- (void)waitingForCardSwipe:(BOOL)status
{
    if(status == SUCCESS) {
        ...
        ZCBTADSwingCardViewController *swingCardVC = [[ZCBTADSwingCardViewController alloc] init];
        swingCardVC.tadeType = self.tadeType;
