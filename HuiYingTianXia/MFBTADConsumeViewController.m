...
@interface MFBTADConsumeViewController ()<AC_POSMangerDelegate,MF_POSMangerDelegate,MPosDelegate>
...
@implementation MFBTADConsumeViewController
...
- (void)waitingForCardSwipe:(BOOL)status
{
    if(status == SUCCESS) {
        ...
        MFBTADSwingCardViewController *swingCardVC = [[MFBTADSwingCardViewController alloc] init];
        swingCardVC.tadeType = self.tadeType;
