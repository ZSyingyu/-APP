...
@interface BBBTConsumeViewController ()<AC_POSMangerDelegate,MF_POSMangerDelegate,MPosDelegate>
...
@implementation BBBTConsumeViewController
...
- (void)waitingForCardSwipe:(BOOL)status
{
    if(status == SUCCESS) {
        ...
        BBBTSwingCardViewController *swingCardVC = [[BBBTSwingCardViewController alloc] init];
        swingCardVC.tadeType = self.tadeType;
