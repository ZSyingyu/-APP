//
//  ZCBTADSwingCardViewController.m
//  HuiYingTianXia
//
...
#import "ZCBTADEnterPsdViewController.h"

@interface ZCBTADSwingCardViewController ()<BLEReaderDelegate,SwipeListener,UITableViewDataSource, UITableViewDelegate,AC_POSMangerDelegate>
...
@implementation ZCBTADSwingCardViewController{
...
{
    ZCBTADEnterPsdViewController *enterPwdVC =[[ZCBTADEnterPsdViewController alloc] init];
    enterPwdVC.tadeType = self.tadeType;
    NSLog(@"type:%u",self.tadeType);
