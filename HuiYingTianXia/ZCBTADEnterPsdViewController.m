//
//  ZCBTADEnterPsdViewController.m
//  HuiYingTianXia
//
...
@interface ZCBTADEnterPsdViewController ()<UITableViewDelegate, UITableViewDataSource,UITextFieldDelegate>
...
@implementation ZCBTADEnterPsdViewController
...
{
    __unsafe_unretained ZCBTADEnterPsdViewController *weakSelf = self;
        ...
        if (self.merchantName.length > 0) {
            switch (indexPath.row) {
                ...
                case 3:{
                    ...
                    NSString *str2 = [self.rate substringWithRange:range2];
